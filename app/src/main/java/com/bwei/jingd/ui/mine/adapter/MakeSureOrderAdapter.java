package com.bwei.jingd.ui.mine.adapter;
...
import com.bwei.jingd.bean.GetCartsBean;
import com.bwei.jingd.bean.SellerBean;
import com.bwei.jingd.R;
import com.bwei.jingd.ui.mine.presenter.MakeSureOrderPresenter;
import com.bwei.jingd.ui.widget.AddSubView;
...
public class MakeSureOrderAdapter extends BaseExpandableListAdapter {
    ...
    public MakeSureOrderAdapter(Context context, List<SellerBean> groupList, List<List<GetCartsBean.DataBean.ListBean>> childList, ProgressDialog progressDialog, MakeSureOrderPresenter mPrsenter) {
